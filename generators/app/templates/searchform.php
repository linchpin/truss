...
<form role="search" method="get" id="searchform" action="<?php esc_html_e( home_url( '/' ) ); ?>">
	<div class="grid-x collapse">
		...
		<div class="small-8 cell">
			<input type="text" value="" name="s" id="s" placeholder="<?php esc_attr_e( 'Search', 'clientname' ); ?>">
		</div>
		...
		<div class="small-4 cell">
			...
			<input type="submit" id="searchsubmit" value="<?php esc_attr_e( 'Search', 'clientname' ); ?>" class="prefix button">
